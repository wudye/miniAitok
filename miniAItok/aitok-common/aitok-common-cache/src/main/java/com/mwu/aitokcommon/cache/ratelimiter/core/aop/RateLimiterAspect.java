package com.mwu.aitokcommon.cache.ratelimiter.core.aop;
...
import com.mwu.aitokcommon.cache.ratelimiter.core.redis.RateLimiterRedisDAO;
...
import static com.mwu.aitok.model.common.enums.HttpCodeEnum.TOO_MANY_REQUESTS;
...
public class RateLimiterAspect {
    ...
    public RateLimiterAspect(List<RateLimiterKeyResolver> keyResolvers, RateLimiterRedisDAO rateLimiterRedisDAO) {
        this.keyResolvers = CustomCollectionUtils.convertMap(keyResolvers, RateLimiterKeyResolver::getClass);
