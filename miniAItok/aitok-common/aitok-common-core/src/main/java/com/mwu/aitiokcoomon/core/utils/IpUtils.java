...
public class IpUtils {
    ...
    public static String getIpLocation(HttpServletRequest request) {
        ...
        try {
            ...
            Map<String, Object> map = OBJECT_MAPPER.readValue(result.toString(), new TypeReference<Map<String, Object>>() {});
            if (map == null) {
                return "";
            }
     ...
     *
     * @param request 请求
     * @return {@link UserAgent} 访问设备（nl.basjes.parse.useragent.UserAgent），解析失败返回 null
     */
