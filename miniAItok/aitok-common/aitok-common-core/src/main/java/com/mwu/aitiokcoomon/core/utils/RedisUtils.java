...
public class RedisUtils {
    ...
    static {
        // 使用自定义的 SpringContextHolder 替代 hutool 的 SpringUtil
        RedisUtils.stringRedisTemplate = SpringContextHolder.getBean(StringRedisTemplate.class);
        if (RedisUtils.stringRedisTemplate == null) {
            log.warn("StringRedisTemplate bean not found in Spring context. RedisUtils may fail until context is initialized.");
        }
    }
