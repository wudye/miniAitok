// java
package com.mwu.aitokcommon.ai.model.midjourney.api;
...
public class MidjourneyApi {
    ...
    public SubmitResponse imagine(ImagineRequest request) {
        if (StringUtils.isEmpty(request.getNotifyHook())) {
    ...
    public List<Notify> getTaskList(Collection<String> ids) {
        String res = post("/task/list-by-condition", Collections.singletonMap("ids", ids));
