package com.mwu.atiokservice.behave.listener;


import com.mwu.aitok.model.behave.domain.UserFavorite;
import com.mwu.aitok.model.behave.mq.BehaveQueueConstant;
...
public class MemberRabbitListener {
    ...
    @Autowired
    private UserFavoriteRepository userFavoriteService;
