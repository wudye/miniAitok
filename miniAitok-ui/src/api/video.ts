...
// 视频流-feed
export async function videoFeed(createTime: string) {
    const data = {
        createTime
    }
...
// 分页查询我的视频
export async function videoMypage(data: any) {
    return await request({
...
// 分页查询用户视频
export async function videoUserpage(data: any) {
    return await request({
...
// 发布视频
export async function publishVideo(data: any) {
    return await request({
...
// 视频分类分页video
export async function videoCategoryPage(data: any) {
    return await request({
...
// 热门视频
export async function hotVideoPage(data : any) {
    return await request({
...
// 用户视频点赞总数
export async function userLikeNums(userId: string) {
    return await request({
...
// 保存标签
export async function saveVideoTag(data: any) {
    return await request({
...
// 查询用户作品
export async function memberInfoPage(data: any) {
    return await request({
...
// 分页查询我的视频合集
export async function myVideoCompilationPage(data: any) {
    return await request({
...
// 根据分类推送视频
export async function pushVideoByCategory(categoryId: string) {
    return await request({
...
// 视频父分类子分类
export async function videoCategoryChildrenList(id: string) {
    return await request({
...
// 视频vo
export async function getVideoVOById(id: string) {
    return await request({
