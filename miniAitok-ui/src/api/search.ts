...
// 视频搜索
export function searchVideo(data: any) {
    return request({
...
// 删除搜索记录
export function delSearchHistory(id: any) {
    return request({
...
export async function searchHotLoad(data: any) {
 ...
 * @returns {*}
 */
export async function videoSearchSuggest(data: any) {
    return await request({
